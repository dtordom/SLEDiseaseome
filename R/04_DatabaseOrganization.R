...
#' ·············································································
#' Database organization by clustering
...
check.packages(c("parallel","matrixStats","stringr","dplyr","tidyr","doParallel",
                 "caret","pbapply","BiocParallel","tibble","pathMED","NbClust",
                 "ConsensusClusterPlus","SNFtool","purrr","igraph","pheatmap",
                 "factoextra","M3C","cluster","foreach","doSNOW","wordcloud",
                 "tm","RColorBrewer","SnowballC","ggplot2","ggalluvial"))


load(paste0(getwd(),"/RData/DB_step4.RData"))


## ······································································ Step 1
## Clustering pathways (Round 1) ---- 

## Merge data from all cohorts
...
save.image(paste0(getwd(),"/RData/CCPaths.RData"))
saveRDS(cp,paste0(getwd(),"/RData/cp.rds"))
...
ggplot(df_long, aes(x = K, stratum = Cluster, alluvium = ID, fill = as.factor(Cluster))) +
  ...
  geom_text(stat = "stratum", aes(label = Cluster), size = 3, color = "black") +
...
## ······································································ Step 2
## Clustering pathways (Round 2) ---- 

load(paste0(getwd(),"/RData/CCPaths.RData"))
...
gc()
save.image(paste0(getwd(),"/RData/ClustersRound2.RData"))
...
save.image(paste0(getwd(),"/RData/DB_Step5.RData"))

## ·············································································
## Save R Object (SLE Diseasome)
# 
# library("dplyr")
# load(paste0(getwd(),"/RData/DB_Step5.RDataa"))
...
save.image(paste0(getwd(),"/RData/SLEDiseasome.RData"))

write.table(DRGs.info,paste0(getwd(),"/Results/SupplementaryTable1.txt"),
